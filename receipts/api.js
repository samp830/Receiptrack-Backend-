 ...
 * GET /api/receipts
 *
 * Retrieve a page of receipts (up to ten at a time).
 */
...
router.put('/:receipt', (req, res, next) => {
  getModel().update(req.params.receipt, req.body, (err, entity) => {
    if (err) {
      next(err);
      return;
    }
 ...
 * Delete a receipt.
 */
router.delete('/:receipt', (req, res, next) => {
